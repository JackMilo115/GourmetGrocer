...
class TestRegistration(unittest.TestCase):
    ...
    def test_1_valid_add_category(self):
        # Login as admin
        ...
        # Move to adminCatagory page
        admin_users_link = self.driver.find_element(By.LINK_TEXT, "Admin Catagory")
    ...
    def test_2_valid_update_category(self):
        # Login as admin
        email_input = self.driver.find_element(By.ID, "email")
        password_input = self.driver.find_element(By.ID, "password")
        submit_button = self.driver.find_element(By.ID, "submit")
    ...
    def test_3_valid_remove_category(self):
        # Login as admin
        email_input = self.driver.find_element(By.ID, "email")
        password_input = self.driver.find_element(By.ID, "password")
        submit_button = self.driver.find_element(By.ID, "submit")
